...
//!
//! Each glyph is 16 bytes — one byte per scanline. Within each byte, bit 7 is
//! the left-most pixel and bit 0 is the right-most. Control characters
//! (0x00–0x1F) are blank. Printable ASCII (0x20–0x7E) have visible glyphs.
//! Code 0x7F is a filled-border rectangle used as a fallback for characters
//! outside the supported range.

pub const FONT_WIDTH: u32 = 8;
pub const FONT_HEIGHT: u32 = 16;

/// Returns the 16-byte glyph bitmap for `c`.
///
/// Characters in the printable ASCII range (U+0020–U+007E) return their
/// corresponding glyph. All other characters return the 0x7F fallback glyph
/// (an outlined rectangle).
pub fn get_glyph(c: char) -> &'static [u8] {
    let idx = if (c as u32) < 128 { c as usize } else { 0x7F };
    let start = idx * FONT_HEIGHT as usize;
    &FONT_DATA[start..start + FONT_HEIGHT as usize]
}

/// 8×16 bitmap font — 128 entries, one per ASCII code.
///
/// Derived from the classic IBM VGA ROM 8×16 character set, which has been
/// reproduced as public-domain reference material throughout OS development
/// literature and kernel projects (Linux, SerenityOS, OSDev wiki, et al.).
#[rustfmt::skip]
static FONT_DATA: [u8; 128 * 16] = [
    ...
    // 0x2C ','
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1C, 0x1C, 0x0C, 0x18, 0x00, 0x00, 0x00,
    // 0x2D '-'
    ...
    // 0x30 '0'
    0x00, 0x00, 0x38, 0x6C, 0xC6, 0xC6, 0xC6, 0xD6, 0xC6, 0xC6, 0x6C, 0x38, 0x00, 0x00, 0x00, 0x00,
    // 0x31 '1'
    ...
    // 0x51 'Q'
    0x00, 0x00, 0x78, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xDC, 0x78, 0x1C, 0x00, 0x00, 0x00, 0x00,
    // 0x52 'R'
    ...
    // 0x57 'W'
    0x00, 0x00, 0xC3, 0xC3, 0xC3, 0xDB, 0xDB, 0xDB, 0xFF, 0x66, 0x66, 0x66, 0x00, 0x00, 0x00, 0x00,
    // 0x58 'X'
    0x00, 0x00, 0xC3, 0xC3, 0x66, 0x3C, 0x18, 0x18, 0x3C, 0x66, 0xC3, 0xC3, 0x00, 0x00, 0x00, 0x00,
    // 0x59 'Y'
    0x00, 0x00, 0xC3, 0xC3, 0xC3, 0x66, 0x3C, 0x18, 0x18, 0x18, 0x18, 0x3C, 0x00, 0x00, 0x00, 0x00,
    // 0x5A 'Z'
    0x00, 0x00, 0xFF, 0xC3, 0x86, 0x0C, 0x18, 0x30, 0x61, 0xC3, 0xC3, 0xFF, 0x00, 0x00, 0x00, 0x00,
    // 0x5B '['
    ...
    // 0x6D 'm'
    0x00, 0x00, 0x00, 0x00, 0x00, 0xCC, 0xFE, 0xD6, 0xD6, 0xD6, 0xD6, 0xC6, 0x00, 0x00, 0x00, 0x00,
    // 0x6E 'n'
    ...
    // 0x7F DEL (fallback outlined rectangle)
