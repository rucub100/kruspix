...
use super::core::{
    ...
    parse_device_descriptor_header, set_address, set_configuration, set_feature, set_interface,
    set_protocol,
};
...
impl KeyboardState {
    ...
    fn has_error_rollover(report: &[u8; KEYBOARD_REPORT_LEN]) -> bool {
        report[2..]
            .iter()
...
impl Bcm2708UsbDevice {
    ...
    fn service_interrupt_polls(&self) {
        ...
        if state.poll_phase != InterruptPollPhase::Idle {
            return;
        }
